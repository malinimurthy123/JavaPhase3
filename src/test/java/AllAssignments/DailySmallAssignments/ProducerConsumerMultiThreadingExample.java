...
public class ProducerConsumerMultiThreadingExample {

    // Producer class which extends the thread
    ...
    // Consumer class which extends the thread
    static class Consumer extends Thread {
        ...
        public void run() {
            ...
            // Controlling the access of the buffer to the shared producer
            synchronized (p.buffer) {
                ...
                // Printing the values of the string buffer and consuming the buffer
                for (int i = 0; i < 4; i++) {
    ...
    // Main class to implement the Producer Consumer problem
    static class GFG {
